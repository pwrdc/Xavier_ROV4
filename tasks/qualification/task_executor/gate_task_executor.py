...
from tasks.qualification.locator.ml_solution.yolo_soln import YoloGateLocator
...
class GateTaskExecutor(ITaskExecutor):
    def __init__(self, control_dict: Movements, sensors_dict, cameras_dict: Cameras, main_logger):
        ...
        self.config = get_config("tasks")['qualification']
    ...
    # centers only in horizontal plane
    # depth is constant and handled by PID
    def center_on_gate(self):
        ...
        while (True):
            ...
            if abs(self._bounding_box.xc) < MAXIMAL_DISTANCE_CENTER:
            ...
            self._control.set_lin_velocity(0, right_speed, 0)
